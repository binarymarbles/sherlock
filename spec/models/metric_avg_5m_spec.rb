...
describe Sherlock::Models::MetricAvg5m do
  context '#validations' do
    let(:metric_avg) { Sherlock::Models::MetricAvg5m.new(:node_id => 'test_node', :timestamp => Time.now, :path => 'test.metric', :counter => 10.0) }
