...
describe Sherlock::Models::MetricAvg1w do
  context '#validations' do
    let(:metric_avg) { Sherlock::Models::MetricAvg1w.new(:node_id => 'test_node', :timestamp => Time.now, :path => 'test.metric', :counter => 10.0) }
